...
\begin{longtable}[]{@{}ll@{}}
\toprule
\textbf{Location} & \textbf{path}\tabularnewline
local (newinstall.sh - based install) &
{[}path\_to\_installation{]}/loadLSST.bash\tabularnewline
development cluster (``lsst-dev'') &
/software/lsstsw/stack/loadLSST.bash\tabularnewline
LSP Notebook aspect (from a terminal) &
/opt/lsst/software/stack/loadLSST.bash\tabularnewline
\bottomrule
\end{longtable}

From the command line, execute the commands below:\\[2\baselineskip]
